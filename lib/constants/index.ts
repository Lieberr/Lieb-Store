...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || 'LiebStore';
...
export const PAYMENT_METHODS = process.env.PAYMENT_MATHODS ? process.env.PAYMENT_METHODS?.split(', ') : ['PayPal', 'Stripe', 'CashOnDelivery'];
