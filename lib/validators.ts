...
export const insertProductsSchema = z.object({
    ...
    banner: z.string().nullable(), // Optional nullable
    price: currency, 
});
...
// Shcema for update user profile
...
// Schema to insert seviews
export const insertReviewsShcema = z.object({
