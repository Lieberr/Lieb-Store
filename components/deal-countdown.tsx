...
const DealCountdown = () => {
    ...
    if(!time) {
        ...
        <div className="flex flex-col gap-2 justify-center">
            <h3 className="text-3xl font-bold">Loading CoutDown...</h3>
        </div>
        </section>
        )
    }
    ...
    return ( <section className="grid grid-cols-1 md:grid-cols-2 my-20">
        <div className="flex flex-col gap-2 justify-center">
            <h3 className="text-3xl font-bold">Dead Of The Month</h3>
            <p>  Get ready for a shopping experience like never before with our Deals
