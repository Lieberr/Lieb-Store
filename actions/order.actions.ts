...
export async function createOrder() {
    try {
        ...
        // Create a transaction to create order and order items in databse
...
// Create new papel order
export async function createdPaypalOrder(orderId: string) {
    try {
...
export async function updateOrderToPaid({
    ...
    paymentResult?: PaymentResult 
        ...
        await prisma.$transaction(async (tx) => {
            // Itera over products and update stock
        ...
        // get up´date order after transaction
